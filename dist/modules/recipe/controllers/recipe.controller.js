...
let RecipeController = class RecipeController {
    ...
    getRecipes(externalId, orderStatus) {
        return this.recipeService.getRecipe(externalId, orderStatus);
    }
};
__decorate([
    common_1.Get(),
    __param(0, common_1.Param('externalId')),
    __param(1, common_1.Param('orderStatus')),
